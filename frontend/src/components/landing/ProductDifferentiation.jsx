  ...
  const cards = [
    {
      ...
      desc: "Surface the silent premises and logical leaps in your thinking. Sparring doesn't nod along; it probes where your evidence is thinnest.",
      icon: Eye,
    ...
    },
    {
      step: "02",
      title: "CHALLENGE",
      subtitle: "Defend against counterarguments.",
      desc: "Experience relentless adversarial dialectic. The AI opponent anticipates common defenses and introduces surgical counterexamples.",
      icon: Shield,
    ...
    },
    {
      step: "03",
      title: "IMPROVE",
      subtitle: "Learn from every round.",
      desc: "Walk away with an unvarnished audit of your debate performance: logical consistency score, evidence strength, and identified fallacies.",
      icon: Award,
